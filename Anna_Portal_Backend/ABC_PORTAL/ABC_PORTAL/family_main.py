...
from history_script import parse_edi_to_csv_for_sql_server
from family_script import send_data_to_family_table
...
input_folder = r"S:\OOE\Temp_Input_Family"
archive_folder = r"S:\OOE\Temp_Archive_Family"
        ...
        if files_list:
            for file_name in files_list:
                ...
                if True:
                    ...
                    'LAST NAME': 'last_name', 'FIRST NAME': 'first_name', 'SSN': 'ssn', 'SUB/DEP': 'sub_dep', 'STATUS': 'status',
                    ...
                    send_data_to_family_table(out_data_df,filedate)
